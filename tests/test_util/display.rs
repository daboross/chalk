...
macro_rules! reparse_test {
    ...
    (program $program:tt) => {
        crate::test_util::display::reparse_test(crate::test_util::strip_leading_trailing_braces(
            stringify!($program),
        ))
    };
    ...
    (program $program:tt produces $diff:tt) => {
        crate::test_util::display::reparse_into_different_test(
            crate::test_util::strip_leading_trailing_braces(stringify!($program)),
            crate::test_util::strip_leading_trailing_braces(stringify!($diff)),
        )
    };
    ...
    (program $program:tt formatting matches $res:literal) => {
        crate::test_util::display::test_formatting(
            crate::test_util::strip_leading_trailing_braces(stringify!($program)),
            $res,
        )
    };
